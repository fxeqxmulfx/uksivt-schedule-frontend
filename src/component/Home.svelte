...
<main>
    ...
    <div class="{theme !== 'dark' ? 'info-footer': 'info-footer info-dark'}">
        v0.6.2 Если найдете глюки, пишите :) <a href="https://vk.com/f_x_eq_x_mul_f_x">vk</a></div>
    <div class="{theme !== 'dark' ? 'info-footer': 'info-footer info-dark'}">
        В среду и пятницу театральный коллектив «Октава» приглашает всех желающих в актовый зал с 12.00 до 17.00 для участия в будущих спектаклях
    </div>
</main>
